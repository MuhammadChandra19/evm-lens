      ...
      <CardContent className="flex-grow overflow-auto">
        <ReactJsonView
          src={{
            ...
            stateMutability:  activeFunction?.type === "function" ? (activeFunction.func as AbiFunction).stateMutability : "",
            inputs: activeFunction?.func.inputs,
            ...( activeFunction?.type === "function" ? { outputs: (activeFunction.func as AbiFunction).outputs} : []),
          }}
        />
      </CardContent>
    </Card>
