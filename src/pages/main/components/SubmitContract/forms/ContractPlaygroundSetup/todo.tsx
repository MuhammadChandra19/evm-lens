      ...
      <div className="max-w-6xl mx-auto space-y-8">
          ...
          <Card className="border-0 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
            <CardContent className="p-8 text-center">
              <h2 className="text-3xl font-bold mb-4">🎯 Smart Contract Playground Setup</h2>
              <p className="text-blue-100 text-lg">Configure your contract parameters and deploy to your local blockchain!</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div>
                <label className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">📍 Contract Address (where it will be deployed)</label>
                <div className="flex gap-2 mt-2">
                  ...
                  />
                  <Button type="button" variant="outline" onClick={generateRandomAddress}>
              ...
              <div>
                <label className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">👤 Owner Address</label>
                <div className="flex gap-2 mt-2">
                  <Input 
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Decimals</label>
                  <Select value={formData.decimals} onValueChange={(value) => updateFormData('decimals', value)}>
            ...
            <CardContent className="space-y-6">
              <div>
                ...
                <Textarea 
                  ...
                  onChange={(e) => updateFormData('constructorBytecode', e.target.value)}
                  rows={4} 
                  className="font-mono text-xs mt-2" 
                />
                <div className="flex gap-2 flex-wrap mt-2">
                  <Button type="button" variant="outline" size="sm" onClick={() => loadTemplate('erc20')}>
                    ERC20 Template
                  </Button>
                  <Button type="button" variant="outline" size="sm">
                    ERC721 Template
              ...
              <div>
                <div className="flex items-center justify-between">
                  <label className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">📋 Contract ABI (Application Binary Interface)</label>
                  <Button type="button" variant="outline" size="sm">
                    <Upload className="w-4 h-4 mr-2" />
                    Upload
                  </Button>
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    <label className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Gas Limit</label>
                    <Input 
                  ...
                  <div>
                    <label className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Gas Price (gwei)</label>
                    <Input 
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                      <div className="flex items-center justify-between">
                          <span className="text-sm font-medium leading-none">Enable debugging mode</span>
                          <Switch checked={true} onCheckedChange={() => {}} />
                      </div>

                      <div className="flex items-center justify-between">
                          <span className="text-sm font-medium leading-none">Record all state changes</span>
                          <Switch checked={true} onCheckedChange={() => {}} />
                      </div>

                      <div className="flex items-center justify-between">
                          <span className="text-sm font-medium leading-none">Trace opcode execution</span>
                          <Switch checked={true} onCheckedChange={() => {}}/>
                      </div>

                      <div className="flex items-center justify-between">
                          <span className="text-sm font-medium leading-none">Auto-explore after deployment</span>
                          <Switch checked={true} onCheckedChange={() => {}}/>
                      </div>
                </div>
              </div>
            ...
            <CardContent>
              <div className="grid grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">⛽ Gas Price: 20 gwei</div>
                </div>
                
                <div>
                  <div className="font-medium mb-2">💰 Test Accounts: 10 loaded</div>
                  <div className="text-sm text-gray-600">💳 Default Balance: 1000 ETH each</div>
                </div>
              </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-sm border-t shadow-lg z-50">
        <div className="max-w-6xl mx-auto p-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center mb-3">
            <Button type="button" variant="outline" size="sm" className="flex-1 max-w-xs">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Button type="button" variant="outline" size="lg" className="border-gray-300 hover:border-gray-400">
              💾 Save Configuration
            </Button>
          </div>
        </div>
